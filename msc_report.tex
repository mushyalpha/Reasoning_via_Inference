...
\noindent Finally, $\text{has\_grasps}=0$ forces $Y=0$ directly. $Y$ is governed by whether the executed pose is close enough to the object, conditional on $\text{has\_grasps}=1$, operationalised in Section~\ref{sec:success_criterion_detail}.
